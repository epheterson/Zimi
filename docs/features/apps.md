...
- **Reddot** reads subreddit ZIMs (ArcticZim's, and the ones the Create page makes): a shelf per subreddit, a subreddit as a list (Top, New), a post with its comment tree. See [making ZIMs](making-zims.md) for making one.
