...
Status: design, no code yet. Companion to `2026-08-07-v19-plan.md` workstream B. Everything here honors the two decrees: **one package, no edition gating** — every feature below ships on for everyone, configuration is what varies — and **the compatibility contract** — an existing single-admin install upgrades to 1.9 and notices nothing.
