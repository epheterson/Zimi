...
ok('the reader\'s bookmark buttons are for articles, not app pages', /body\.app-page #bm-panel-btn, body\.app-page #library-btn, body\.map-page #bm-panel-btn, body\.map-page #library-btn \{ display: none !important; \}/.test(css));
