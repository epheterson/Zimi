...
Some ZIMs hold a map, a video library, a Q&A site, a subreddit, a wiki or a library of books. Zimi gives each kind a view of its own, over whatever you already have.
...
- [Apps](docs/features/apps.md), Maps, ZimiTube, ZimiExchange, Reddot, Zimipedia and Bookshelf: Zimi's own views over the map, video, Q&A, subreddit, wiki and book ZIMs in the library; one thing once across builds; the apps switch.
