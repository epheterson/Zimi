...
- Import a web archive from the Create page. Put a .warc, .warc.gz or .wacz in the library folder (or its imports subfolder) and pick it from the list; no path is typed. Primary admin only.
