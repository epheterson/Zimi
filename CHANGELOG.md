...
- Zimipedia, an app for every wiki in the library (Wikipedia in any language, Wiktionary, Wikivoyage, Wikiquote, Wikibooks and the other MediaWiki wikis), one language at a time: a chip per language the wikis are in, each named in itself and remembered in your browser, switches the whole page, with a pill per wiki of that language to narrow it. Today reads like a wiki's front page: the day's article from the language's Wikipedia with its picture; On this day from the Wikipedia's own date page, with pictures (English, German, French, Spanish, Portuguese, Italian, Russian, Ukrainian, Polish, Dutch, Turkish, Chinese, Japanese, Korean, Hebrew, Yiddish, Arabic, Persian, Hindi, Vietnamese, Indonesian, Swedish and more); Did you know, facts from the leads of the day's articles; a picture of the day; a rabbit hole of links followed from the day's article; a word, a quote, a place, a book, a text, a lesson or a species from the other wikis of the language; and what each wiki's own front page featured (its featured article, Did you know, quote, word or book), dated as of the day the copy was made. Search stays in the language, with one tap to search every language, and shows cards or a list. Everything is worked out once, soon after the server starts and after each midnight, so opening Today is one request. Its name for `ZIMI_APPS` is `wiki`.
...
- Making a subreddit into a ZIM works again: SQLAlchemy 2.1, released 2026-09-24, broke the Reddit maker's build. It is pinned below 2.1, and a maker installed with 2.1 is reinstalled the next time it runs online.
