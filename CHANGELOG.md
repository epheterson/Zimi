...
- Create a ZIM: a site capture's **Max pages** takes any number, and 0 captures with no page limit; the size budget still bounds it. Anything over 50,000 used to be cut to 50,000 without a word.
